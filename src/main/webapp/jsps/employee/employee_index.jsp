			...
			<div class="main-layout-side">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="leftNav">
				  <li class="layui-nav-item">
				    <a href="javascript:{changeSrc('<c:url value='/PlanServlet?method=getTask&username=${sessionScope.Luser.truename}&url=/jsps/employee/PlanManagement.jsp'/>')}"><i class="iconfont">&#xe60a;</i>计划管理</a>
				  </li>
				  <li class="layui-nav-item">
				    <a href="javascript:{changeSrc('<c:url value='/PlanServlet?method=getTask&username=${sessionScope.Luser.truename}&url=/jsps/employee/SearchPlan.jsp'/>')}"><i class="iconfont">&#xe60a;</i>查询计划</a>
				  </li>
				</ul>
			</div>
			<!--右侧内容-->
