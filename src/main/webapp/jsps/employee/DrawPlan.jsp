...
<body>
	...
	<tr><td><a href="<c:url value='/PlanServlet?method=backInfo&pid=${p.pid }'/>">${p.pname }</a></td>
	<td>
	<c:choose>
	...
	<td>${p.pstart }</td>
	<td>${p.pend }</td>
	<td><a href="<c:url value='PlanServlet?method=deletePlan&pid=${p.pid }'/>">删除</a></td>
	</tr>
	</c:forEach>
	<tr><td align="center" colspan="6"><a href="<c:url value='/PlanServlet?method=forAddPlan&tid=${task.tid }'/>">新建</a></td></tr>
	</table>
	</form>
</body>
</html>